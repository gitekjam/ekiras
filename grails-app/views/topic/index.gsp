		...
		<div id="list-topic" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="topic.category.label" default="Category" /></th>
				...
				<g:each in="${topicInstanceList}" status="i" var="topicInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${topicInstance.id}">${fieldValue(bean: topicInstance, field: "category")}</g:link></td>
