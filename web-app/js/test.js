...
$(document).ready(function(){
 ...
 $(".view-solution, .hide-solution").click(function(){
  $(this).siblings(".solution").slideToggle("hidden");
...
function finishTest(){
   $.each($("#test-container").children(".container-question"),function(){
    $.each($(this).children(".handle.hidden"), function(){$(this).toggleClass("hidden")});});
...
function showScore(){
 var content = "<table cellpadding='5' cellspacing='0' border='1' width='100%'><tr>";
 var answers = $(".answer");
